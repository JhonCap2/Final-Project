        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link to="/dashboard" className="flex items-center">
              <img className="h-12 w-auto" src="/logo.png" alt="AllergySafety Logo" />
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button onClick={handleLogoutClick} className="text-gray-500 hover:text-red-500 transition-colors" title="Cerrar Sesión">
      ...
      {isMenuOpen && (
        <div className="md:hidden" id="mobile-menu">
          ...
          <div className="pt-4 pb-3 border-t border-gray-200 px-2">
            <button onClick={handleLogoutClick} className="w-full text-left block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900">
              Cerrar Sesión
            </button>
          </div>
        </div>
